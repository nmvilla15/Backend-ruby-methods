...
And if a>b, it should evaluate to 1. Here is the start of a program, which you should call sort_blocks.rb.
...
call to sort, pass a block so that the array is sorted in order of title, and print out the array.  For your second call to sort, pass a block so that
...
puts "Sorting alphabetically by book title"
...
puts "Sorting book copy count from low to high"
